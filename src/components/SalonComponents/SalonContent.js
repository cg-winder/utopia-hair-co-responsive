  ...
  return (
    <div className="saloncontent-wrap">
        <div className="salon-about-info-1">
          <h2>our salon</h2>
          <p>
           Utopia Hair Co is a spa-like salon based in a beautiful barn conversion on Clifton Fields, just
            outside of Freckleton. It is home to six amazing freelance artists, who create a friendly and relaxed
