  ...
  return (
    <div className="services-policies">
        ...
        <div className="cancellation-policy">
            ...
            <p className="policy-p">We kindly ask that all cancellations are made at least 48 hours prior to appointment time. If you cancel or modify your appointment within 48 hours of your scheduled appointment time, it is classed as a late cancellation and there is a non-refundable 50% fee. There is also a non-refundable 100% fee for no shows or cancellations on the day of your appointment. To cancel, you can choose to message your artist on their Instagram or cancel directly on their<a href="https://linktr.ee/utopiahairco"> booking system.</a> Appointments are held for up to 15 minutes. Please let us know if you are running late and we will try accommodate you as best we can.</p>
        </div>
        ...
        <div className="patchtest-policy">
            ...
            <p className="policy-p">For all new hair clients a consultation and skin test is required before any appointment. All extension services require a complimentary consultation with Nicola prior to booking of appointment. For hair, brows and lashes, a skin test is required 48 hours before appointments.</p>
        </div>
