  ...
  return (
    <div className="services-policies">
      ...
      <div className="gift-card">
        ...
        <p className="policy-p">Gift cards can be purchased from your stylist through their individual Fresha webpage found <a href="https://linktr.ee/utopiahairco">here.</a></p>
      </div>
    </div>
  )
}
